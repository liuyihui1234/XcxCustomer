...
Page({
  ...
  bindSheetChange: function (e) {
    ...
    console.log(that.data.sheetCode);
  },
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (res.data.code == 1) {//成功
          ...
          prevPage.setData({
            toname: that.data.contactname,
            toprovince: that.data.provincecode,
            toprovincename: that.data.province,
            tocityname: that.data.city,
            tocity: that.data.citycode,
            toareaname: that.data.county,
            toarea: that.data.countycode,
            toareastreetname: that.data.areastreet,
            toareastreet: that.data.areastreetcode,
            toaddress: that.data.address,
            totel: that.data.contactphone,
            tocode: that.data.provincecode
          });
